...
import { sequenceBasicNarrations } from './data/6.1/6.1-basic-narrations';
import { sequenceBasicProgressItems } from './data/6.1/6.1-basic-progress';
...
export function SequenceBasicPage() {
  ...
  return (
    <div>
      ...
      {/* Section 1: 等差数列的定义 */}
      {/* ════════════════════════════════════════════════════════ */}
      <section id="arith-def" className="scroll-mt-4">
        <Collapsible title="一、等差数列的定义" defaultOpen storageKey="seq-basic:arith-def" headerExtra={<SpeakButton text={sequenceBasicNarrations.arithDef} />}>
          <div className="space-y-0 text-[0.9rem] text-gray-800">
            ...
            <div className="border border-blue-300 rounded overflow-hidden">
              <div className="px-2 py-1 font-bold text-blue-800 border-b border-blue-300 bg-blue-100 text-[0.9rem]">等差数列 = 每次加同一个数</div>
            ...
            <div className="border border-green-300 rounded overflow-hidden">
              <div className="px-2 py-1 font-bold text-green-800 border-b border-green-300 bg-green-100 text-[0.9rem]">公差 d 的三种情况</div>
              <div className="px-3 py-2 space-y-0">
            ...
            <div className="border border-amber-300 rounded overflow-hidden">
              <div className="px-2 py-1 font-bold text-amber-800 border-b border-amber-300 bg-amber-100 text-[0.9rem]">怎么判断？看相邻两项的差</div>
              <div className="px-3 py-2 space-y-0">
            ...
            <div className="border border-gray-300 rounded overflow-hidden">
              <div className="px-2 py-1 font-bold text-gray-800 border-b border-gray-300 bg-gray-100 text-[0.9rem]">生活中的等差数列</div>
              <div className="px-3 py-2 space-y-0">
      ...
      {/* Section 2: 等差数列的通项公式 */}
      {/* ════════════════════════════════════════════════════════ */}
      <section id="arith-formula" className="scroll-mt-4">
        <Collapsible title="二、等差数列的通项公式" defaultOpen storageKey="seq-basic:arith-formula" headerExtra={<SpeakButton text={sequenceBasicNarrations.arithFormula} />}>
          <div className="space-y-0 text-[0.9rem] text-gray-800">
            ...
            <div className="border border-blue-300 rounded overflow-hidden">
              <div className="px-2 py-1 font-bold text-blue-800 border-b border-blue-300 bg-blue-100 text-[0.9rem]">公式（必背）</div>
              <div className="px-3 py-2 space-y-0">
            ...
            <div className="border border-green-300 rounded overflow-hidden">
              <div className="px-2 py-1 font-bold text-green-800 border-b border-green-300 bg-green-100 text-[0.9rem]">为什么是 n-1 而不是 n？</div>
              <div className="px-3 py-2 space-y-0">
            ...
            <div className="border border-amber-300 rounded overflow-hidden">
              <div className="px-2 py-1 font-bold text-amber-800 border-b border-amber-300 bg-amber-100 text-[0.9rem]">实战演练</div>
              <div className="px-3 py-2 space-y-0">
            ...
            <div className="border border-purple-300 rounded overflow-hidden">
              <div className="px-2 py-1 font-bold text-purple-800 border-b border-purple-300 bg-purple-100 text-[0.9rem]">推广形式（从任意项出发）</div>
              <div className="px-3 py-2 space-y-0">
      ...
      {/* ════════════════════════════════════════════════════════ */}
      <section id="arith-sum" className="scroll-mt-4">
        <Collapsible title="三、等差数列的前 n 项和" defaultOpen storageKey="seq-basic:arith-sum" headerExtra={<SpeakButton text={sequenceBasicNarrations.arithSum} />}>
          <div className="space-y-0 text-[0.9rem] text-gray-800">
            ...
            <div className="border border-blue-300 rounded overflow-hidden">
              <div className="px-2 py-1 font-bold text-blue-800 border-b border-blue-300 bg-blue-100 text-[0.9rem]">两种写法（必背）</div>
              <div className="px-3 py-2 space-y-0">
            ...
            <div className="border border-green-300 rounded overflow-hidden">
              <div className="px-2 py-1 font-bold text-green-800 border-b border-green-300 bg-green-100 text-[0.9rem]">公式怎么来的？——高斯的故事</div>
              <div className="px-3 py-2 space-y-0">
            ...
            <div className="border border-gray-300 rounded overflow-hidden">
              <div className="px-2 py-1 font-bold text-gray-800 border-b border-gray-300 bg-gray-100 text-[0.9rem]">记忆口诀</div>
              <div className="px-3 py-2 space-y-0">
      ...
      <PageBreak label="等差性质" />

      {/* ════════════════════════════════════════════════════════ */}
      {/* Section 4: 等差数列的性质 */}
      {/* ════════════════════════════════════════════════════════ */}
      <section id="arith-props" className="scroll-mt-4">
        <Collapsible title="四、等差数列的性质" defaultOpen storageKey="seq-basic:arith-props" headerExtra={<SpeakButton text={sequenceBasicNarrations.arithProps} />}>
          <div className="space-y-0 text-[0.9rem] text-gray-800">
            ...
            <div className="border border-blue-300 rounded overflow-hidden">
              <div className="px-2 py-1 font-bold text-blue-800 border-b border-blue-300 bg-blue-100 text-[0.9rem]">性质 1：下标和相等 → 项的和也相等</div>
              <div className="px-3 py-1 space-y-0">
                <p className="text-center text-xl"><MathTex tex="m + n = p + q \;\Rightarrow\; a_m + a_n = a_p + a_q" /></p>
                <p>例：<MathTex tex="a_3 + a_7 = a_4 + a_6 = a_1 + a_9 = 2a_5" />（下标之和都是 10）</p>
              </div>
            </div>

            <div className="border border-green-300 rounded overflow-hidden">
              <div className="px-2 py-1 font-bold text-green-800 border-b border-green-300 bg-green-100 text-[0.9rem]">性质 2：等差中项</div>
              <div className="px-3 py-1 space-y-0">
                <p className="text-center text-xl"><MathTex tex="a, A, b \text{ 成等差} \;\Rightarrow\; A = \dfrac{a + b}{2}" /></p>
                <p><MathTex tex="A" /> 叫<strong>等差中项</strong>，就是平均数。例：<MathTex tex="3, \underline{\quad}, 11" /> → 中间 = <MathTex tex="\dfrac{3+11}{2} = 7" /></p>
              </div>
            </div>

            <div className="border border-purple-300 rounded overflow-hidden">
              <div className="px-2 py-1 font-bold text-purple-800 border-b border-purple-300 bg-purple-100 text-[0.9rem]">性质 3：Sₙ 是关于 n 的二次函数</div>
              <div className="px-3 py-1 space-y-0">
                <p>展开：<MathTex tex="S_n = \dfrac{d}{2}n^2 + \left(a_1 - \dfrac{d}{2}\right)n" />，是二次函数且<strong>没有常数项</strong></p>
                <p>判断依据：<MathTex tex="S_n = An^2 + Bn" />（无常数项）→ 一定是等差数列</p>
              </div>
            </div>

            <div className="border border-red-300 rounded overflow-hidden">
              <div className="px-2 py-1 font-bold text-red-800 border-b border-red-300 bg-red-100 text-[0.9rem]">高考常见套路</div>
              <div className="px-3 py-1 space-y-0">
                <p>题目给 <MathTex tex="a_3 + a_7 = 20" />，问 <MathTex tex="a_5" /> 或 <MathTex tex="S_9" /></p>
                <p>用性质 1：<MathTex tex="a_3 + a_7 = 2a_5 = 20 \Rightarrow a_5 = 10" /></p>
                <p><MathTex tex="S_9 = \dfrac{9 \times 2a_5}{2} = 9 \times 10 = 90" /></p>
                <p className="font-bold text-red-700">不需要求 <MathTex tex="a_1" /> 和 <MathTex tex="d" />，直接秒杀</p>
              </div>
            </div>
      ...
      {/* Section 5: 等比数列的定义 */}
      {/* ════════════════════════════════════════════════════════ */}
      <section id="geo-def" className="scroll-mt-4">
        <Collapsible title="五、等比数列的定义" defaultOpen storageKey="seq-basic:geo-def" headerExtra={<SpeakButton text={sequenceBasicNarrations.geoDef} />}>
          <div className="space-y-0 text-[0.9rem] text-gray-800">
            ...
            <div className="border border-blue-300 rounded overflow-hidden">
              <div className="px-2 py-1 font-bold text-blue-800 border-b border-blue-300 bg-blue-100 text-[0.9rem]">等比数列 = 每次乘同一个数</div>
              <div className="px-3 py-2 space-y-0">
            ...
            <div className="border border-green-300 rounded overflow-hidden">
              <div className="px-2 py-1 font-bold text-green-800 border-b border-green-300 bg-green-100 text-[0.9rem]">公比 q 的三种情况</div>
              <div className="px-3 py-2 space-y-0">
                <div className="grid grid-cols-3 gap-2">
                  <div className="bg-blue-50 rounded-lg p-1.5 border border-blue-200 text-center">
            ...
            <div className="border border-red-300 rounded overflow-hidden">
              <div className="px-2 py-1 font-bold text-red-800 border-b border-red-300 bg-red-100 text-[0.9rem]">两个重要限制</div>
              <div className="px-3 py-2 space-y-0">
            ...
            <div className="border border-gray-300 rounded overflow-hidden">
              <div className="px-2 py-1 font-bold text-gray-800 border-b border-gray-300 bg-gray-100 text-[0.9rem]">生活中的等比数列</div>
              <div className="px-3 py-2 space-y-0">
      ...
      {/* Section 6: 等比数列的通项公式 */}
      {/* ════════════════════════════════════════════════════════ */}
      <section id="geo-formula" className="scroll-mt-4">
        <Collapsible title="六、等比数列的通项公式" defaultOpen storageKey="seq-basic:geo-formula" headerExtra={<SpeakButton text={sequenceBasicNarrations.geoFormula} />}>
          <div className="space-y-0 text-[0.9rem] text-gray-800">
            ...
            <div className="border border-green-300 rounded overflow-hidden">
              <div className="px-2 py-1 font-bold text-green-800 border-b border-green-300 bg-green-100 text-[0.9rem]">和等差对比记忆</div>
              <div className="px-3 py-2 space-y-0">
            ...
            <div className="border border-purple-300 rounded overflow-hidden">
              <div className="px-2 py-1 font-bold text-purple-800 border-b border-purple-300 bg-purple-100 text-[0.9rem]">推广形式</div>
              <div className="px-3 py-2 space-y-0">
      ...
      {/* ════════════════════════════════════════════════════════ */}
      <section id="geo-sum" className="scroll-mt-4">
        <Collapsible title="七、等比数列的前 n 项和" defaultOpen storageKey="seq-basic:geo-sum" headerExtra={<SpeakButton text={sequenceBasicNarrations.geoSum} />}>
          <div className="space-y-0 text-[0.9rem] text-gray-800">
            ...
            <div className="border border-blue-300 rounded overflow-hidden">
              <div className="px-2 py-1 font-bold text-blue-800 border-b border-blue-300 bg-blue-100 text-[0.9rem]">公式（必背，注意分类！）</div>
              <div className="px-3 py-2 space-y-0">
                <p className="text-center text-xl"><MathTex tex="S_n = \begin{cases} na_1, & q = 1 \\ \dfrac{a_1(1 - q^n)}{1 - q}, & q \neq 1 \end{cases}" /></p>
            ...
            <div className="border border-red-300 rounded overflow-hidden">
              <div className="px-2 py-1 font-bold text-red-800 border-b border-red-300 bg-red-100 text-[0.9rem]">高考丢分重灾区</div>
              <div className="px-3 py-2 space-y-0">
      ...
      {/* Section 8: 等比数列的性质 */}
      {/* ════════════════════════════════════════════════════════ */}
      <section id="geo-props" className="scroll-mt-4">
        <Collapsible title="八、等比数列的性质" defaultOpen storageKey="seq-basic:geo-props" headerExtra={<SpeakButton text={sequenceBasicNarrations.geoProps} />}>
          <div className="space-y-0 text-[0.9rem] text-gray-800">
            ...
            <div className="border border-blue-300 rounded overflow-hidden">
              <div className="px-2 py-1 font-bold text-blue-800 border-b border-blue-300 bg-blue-100 text-[0.9rem]">性质 1：下标和相等 → 项的积也相等</div>
              <div className="px-3 py-2 space-y-0">
            ...
            <div className="border border-green-300 rounded overflow-hidden">
              <div className="px-2 py-1 font-bold text-green-800 border-b border-green-300 bg-green-100 text-[0.9rem]">性质 2：等比中项</div>
              <div className="px-3 py-2 space-y-0">
            ...
            <div className="border border-purple-300 rounded overflow-hidden">
              <div className="px-2 py-1 font-bold text-purple-800 border-b border-purple-300 bg-purple-100 text-[0.9rem]">性质 3：分段和也成等比</div>
              <div className="px-3 py-2 space-y-0">
