...
export function SolveTriangleAnswers() {
  return (
    <section className="mb-8 print-answers">
      ...
      {/* ═══════════ 一、正弦定理训练（5 题）═══════════ */}
      <div className="mb-5">
        <p className="font-bold text-gray-800 mb-2 border-b border-gray-200 pb-1">一、正弦定理训练</p>
        ...
        <div className="columns-2 gap-4 text-gray-700">
          ...
          <div className="flex gap-2 items-start mb-3" style={{ breakInside: 'avoid' }}>
            ...
            <div className="min-w-0">
              ...
              <p className="mt-1">先找对边对角：边 <MathTex tex="a" /> 对角 <MathTex tex="A" />，边 <MathTex tex="b" /> 对角 <MathTex tex="B" /></p>
          ...
          <div className="flex gap-2 items-start mb-3" style={{ breakInside: 'avoid' }}>
            ...
            <div className="min-w-0">
              <p className="font-bold text-gray-900">答案：A</p>
              <p className="mt-1">由 <MathTex tex="\dfrac{a}{\sin A}=2R" /> 可得 <MathTex tex="a=2R\sin A" /></p>
          ...
          <div className="flex gap-2 items-start mb-3" style={{ breakInside: 'avoid' }}>
            ...
            <div className="min-w-0">
              ...
              <p className="mt-2"><strong>第①步：</strong>用正弦定理求 <MathTex tex="\sin B" /></p>
          ...
          <div className="flex gap-2 items-start mb-3" style={{ breakInside: 'avoid' }}>
            ...
            <div className="min-w-0">
              <p className="font-bold text-gray-900">答案：C（<MathTex tex="\sqrt{6}" />）</p>

              <p className="mt-2">已知边 <MathTex tex="b=2" /> 和它的对角 <MathTex tex="B=45°" />，求 <MathTex tex="a" />（对角 <MathTex tex="A=60°" />）</p>
              <p className="mt-1">由正弦定理：</p>
      ...
      {/* ═══════════ 二、余弦定理训练（6 题）═══════════ */}
      <div className="mb-5">
        <p className="font-bold text-gray-800 mb-2 border-b border-gray-200 pb-1">二、余弦定理训练</p>
        ...
        <div className="columns-2 gap-4 text-gray-700">
          ...
          <div className="flex gap-2 items-start mb-3" style={{ breakInside: 'avoid' }}>
            <span className="text-blue-600 font-bold shrink-0">1.</span>
            <div className="min-w-0">
              <p className="font-bold text-gray-900">答案：C（49）</p>
              <p className="mt-1">已知两边和夹角，直接用余弦定理：</p>
          ...
          <div className="flex gap-2 items-start mb-3" style={{ breakInside: 'avoid' }}>
            ...
            <div className="min-w-0">
              <p className="font-bold text-gray-900">答案：B</p>
              <p className="mt-1">余弦定理求对边 <MathTex tex="a" />：</p>
          ...
          <div className="flex gap-2 items-start mb-3" style={{ breakInside: 'avoid' }}>
            <span className="text-blue-600 font-bold shrink-0">3.</span>
            <div className="min-w-0">
              <p className="font-bold text-gray-900">答案：C（120°）</p>
              <p className="mt-1">已知三边求角，用余弦定理变形：</p>
          ...
          <div className="flex gap-2 items-start mb-3" style={{ breakInside: 'avoid' }}>
            ...
            <div className="min-w-0">
              ...
              <p className="mt-1">把已知式和余弦定理对比：</p>
          ...
          <div className="flex gap-2 items-start mb-3" style={{ breakInside: 'avoid' }}>
            <span className="text-blue-600 font-bold shrink-0">5.</span>
            <div className="min-w-0">
              <p className="font-bold text-gray-900">答案：A（锐角三角形）</p>
              <p className="mt-1">最大边 <MathTex tex="c=6" />，比较 <MathTex tex="a^2+b^2" /> 与 <MathTex tex="c^2" />：</p>
      ...
      {/* ═══════════ 三、面积公式训练（6 题）═══════════ */}
      <div className="mb-5">
        <p className="font-bold text-gray-800 mb-2 border-b border-gray-200 pb-1">三、面积公式训练</p>
        ...
        <div className="columns-2 gap-4 text-gray-700">
          ...
          <div className="flex gap-2 items-start mb-3" style={{ breakInside: 'avoid' }}>
            ...
            <div className="min-w-0">
              ...
              <p className="mt-1">面积公式 <MathTex tex="S=\dfrac{1}{2}ab\sin C" />，<MathTex tex="a,b" /> 是夹角 <MathTex tex="C" /> 的两边</p>
          ...
          <div className="flex gap-2 items-start mb-3" style={{ breakInside: 'avoid' }}>
            ...
            <div className="min-w-0">
              ...
              <p className="mt-1">角 <MathTex tex="A" /> 夹在边 <MathTex tex="b,c" /> 之间：</p>
          ...
          <div className="flex gap-2 items-start mb-3" style={{ breakInside: 'avoid' }}>
            <span className="text-blue-600 font-bold shrink-0">3.</span>
            <div className="min-w-0">
              <p className="font-bold text-gray-900">答案：C（<MathTex tex="4\sqrt{3}" />）</p>
              <p className="mt-1">等边三角形每个角都是 <MathTex tex="60°" /></p>
          ...
          <div className="flex gap-2 items-start mb-3" style={{ breakInside: 'avoid' }}>
            <span className="text-blue-600 font-bold shrink-0">4.</span>
            <div className="min-w-0">
              <p className="font-bold text-gray-900">答案：B（<MathTex tex="\dfrac{1}{2}" />）</p>
              <p className="mt-1">由面积公式 <MathTex tex="S=\dfrac{1}{2}ab\sin C" />：</p>
          ...
          <div className="flex gap-2 items-start mb-3" style={{ breakInside: 'avoid' }}>
            ...
            <div className="min-w-0">
              <p className="font-bold text-gray-900">答案：B（12）</p>
              <p className="mt-1">已知三边，先求角 <MathTex tex="C" /> 的三角函数：</p>
          ...
          <div className="flex gap-2 items-start mb-3" style={{ breakInside: 'avoid' }}>
            <span className="text-blue-600 font-bold shrink-0">6.</span>
            <div className="min-w-0">
              <p className="font-bold text-gray-900">答案：C（<MathTex tex="\sqrt{37}" />）</p>
              <p className="mt-1"><strong>第①步：</strong>由面积公式求 <MathTex tex="\sin C" /></p>
      ...
      {/* ═══════════ 四、综合实战训练（3 题）═══════════ */}
      <div className="mb-5">
        <p className="font-bold text-gray-800 mb-2 border-b border-gray-200 pb-1">四、综合实战训练</p>
        ...
        <div className="columns-2 gap-4 text-gray-700">
          ...
          <div className="flex gap-2 items-start mb-3" style={{ breakInside: 'avoid' }}>
            <span className="text-blue-600 font-bold shrink-0">1.</span>
            <div className="min-w-0">
              <p className="font-bold text-gray-900">答案：A（<MathTex tex="\dfrac{3\sqrt{3}}{2}" />）</p>
              <p className="mt-1"><strong>第①步：求角 A</strong></p>
          ...
          <div className="flex gap-2 items-start mb-3" style={{ breakInside: 'avoid' }}>
            <span className="text-blue-600 font-bold shrink-0">2.</span>
            <div className="min-w-0">
              <p className="font-bold text-gray-900">答案：B（<MathTex tex="\dfrac{\pi}{3}" />）</p>
              <p className="mt-1"><strong>关键结论：</strong>在三角形中 <MathTex tex="a\cos B+b\cos A=c" />（射影定理）</p>
          ...
          <div className="flex gap-2 items-start mb-3" style={{ breakInside: 'avoid' }}>
            ...
            <div className="min-w-0">
              ...
              <p className="mt-1">由正弦定理 <MathTex tex="\dfrac{a}{\sin A}=2R" /></p>
