...
const phases: Phase[] = [
  ...
  },
  {
    ...
    modules: [
      ...
      { path: '/math/deriv-method', label: '3.6.0 单调性入门', time: '1-2小时', desc: '通用流程 + 求不含参函数的单调区间（3.6 系列地基）', prereq: true },
      { path: '/math/derivative-application-2', label: '3.6.1 含参单调性专题', time: '2-3小时', desc: '恒成立 + 有解 + 含参讨论' },
      { path: '/math/extrema', label: '3.6.2 极值与最值', time: '1-2小时', desc: '驻点→判号→极值判定；4 种函数类型' },
