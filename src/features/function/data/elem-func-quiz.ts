...
export const elemFuncQuizQuestions: QuizQuestionData[] = [
  // 对数运算法则
  {
    ...
    correctAnswer: '2',
    explanation: '',
    explanationLatex: '\\lg 25 + \\lg 4 = \\lg(25 \\times 4) = \\lg 100 = 2',
  },
  {
    id: 'efq-2',
    question: '（改编自2021·全国）',
    ...
    explanation: '',
    explanationLatex: '\\text{换底：}\\log_4 8 = \\dfrac{\\lg 8}{\\lg 4} = \\dfrac{\\lg 2^3}{\\lg 2^2} = \\dfrac{3\\lg 2}{2\\lg 2} = \\dfrac{3}{2}',
  },
  // 指数函数
  {
    id: 'efq-3',
    ...
    explanation: '',
    explanationLatex: '\\text{底数 }0.6\\text{，满足 }0 < a < 1 \\rightarrow \\text{减函数}\\\\[4pt]\\text{减函数：指数越大，值越小}\\\\[4pt]1.5 < 2.5 \\Rightarrow 0.6^{1.5} > 0.6^{2.5}',
  },
  {
    id: 'efq-4',
    ...
    correctAnswer: '2',
    explanation: '',
    explanationLatex: 'f(3) = a^3 = 8 \\Rightarrow a = \\sqrt[3]{8} = 2\\\\[4pt]f(1) = 2^1 = 2',
  },
  // 对数函数
  {
    id: 'efq-5',
    ...
    explanation: '',
    explanationLatex: '\\text{A: }\\lg 10 = 1 > 0\\\\[4pt]\\text{B: }\\ln e = 1 > 0\\\\[4pt]\\text{C: }\\log_2 3 > \\log_2 1 = 0\\\\[4pt]\\text{D: 底数 }3 > 1\\text{，真数 }\\dfrac{1}{2} < 1 \\Rightarrow \\text{负数}\\checkmark',
  },
  // 幂函数
  {
    id: 'efq-6',
    ...
    explanation: '',
    explanationLatex: '\\text{代入 }(4, 2)\\text{：}2 = 4^{\\alpha}\\\\[4pt]4^{\\frac{1}{2}} = \\sqrt{4} = 2\\;\\checkmark\\\\[4pt]\\text{所以 }\\alpha = \\dfrac{1}{2}',
  },
  // 综合
  {
    id: 'efq-7',
    ...
    explanation: '',
    explanationLatex: '2^{0.3}\\text{：底数 }2>1\\text{，指数 }>0 \\Rightarrow 2^{0.3} > 2^0 = 1\\\\[4pt]0.3^2 = 0.09\\text{，在 }0\\text{ 和 }1\\text{ 之间}\\\\[4pt]\\log_2 0.3\\text{：底数 }2>1\\text{，真数 }0.3<1 \\Rightarrow \\text{负数}\\\\[4pt]\\text{所以 }\\log_2 0.3 < 0 < 0.3^2 < 1 < 2^{0.3}',
  },
  {
    id: 'efq-8',
    question: '（改编自2022·浙江）',
    ...
    correctAnswer: '4',
    explanation: '',
    explanationLatex: '3^{2a} = (3^a)^2 = 2^2 = 4\\\\[4pt]\\text{指数法则：}a^{mn} = (a^m)^n',
  },
];
