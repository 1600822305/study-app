...
// ── 1.4 含参讨论单调性 · 即时练习（5 题，覆盖 4 大题型，按高考难度递进） ──
export const derivMonoDiscussPractice: QuizQuestionData[] = [
  {
    id: 'dm4-1',
    type: 'blank',
    question: '',
    questionLatex: '\\text{讨论 }f(x)=ax-2\\ln x\\text{ 在 }(0,+\\infty)\\text{ 上的单调性（按 }a\\text{ 分类）}',
    correctAnswer: 'a\\le 0:(0,+\\infty)\\text{ 减};a>0:(0,2/a)\\text{ 减},(2/a,+\\infty)\\text{ 增}',
    acceptableAnswers: [
      'a\\le 0:(0,+\\infty)\\text{ 减};a>0:(0,2/a)\\text{ 减},(2/a,+\\infty)\\text{ 增}',
      'a≤0时减；a>0时(0,2/a)减(2/a,+∞)增',
    ],
  },
  {
    id: 'dm4-2',
    type: 'blank',
    question: '',
    questionLatex: '\\text{讨论 }f(x)=\\dfrac{1}{3}x^3-ax^2+1\\text{ 的单调性（按 }a\\text{ 分类）}',
  ...
  },
  {
    ...
    type: 'blank',
    question: '',
    questionLatex: '\\text{讨论 }f(x)=x^3-3ax^2\\text{ 在 }[1,2]\\text{ 上的单调性（按 }a\\text{ 分类）}',
  ...
  },
  {
    ...
    type: 'blank',
    question: '',
    questionLatex: '\\text{讨论 }f(x)=\\dfrac{1}{2}x^2-ax+\\ln x\\text{ 的单调性（按 }a\\text{ 分类）}',
    correctAnswer: 'a\\le 2:(0,+\\infty)\\text{ 增};a>2:(0,x_1),(x_2,+\\infty)\\text{ 增},(x_1,x_2)\\text{ 减},x_{1,2}=(a\\mp\\sqrt{a^2-4})/2',
    acceptableAnswers: [
      'a\\le 2:(0,+\\infty)\\text{ 增};a>2:(0,x_1),(x_2,+\\infty)\\text{ 增},(x_1,x_2)\\text{ 减}',
    ],
  },
  {
    id: 'dm4-5',
    type: 'blank',
    question: '',
    questionLatex: '\\text{讨论 }f(x)=a\\ln x-x^2+1\\text{ 在 }(0,+\\infty)\\text{ 上的单调性（按 }a\\text{ 分类）}',
    correctAnswer: 'a\\le 0:(0,+\\infty)\\text{ 减};a>0:(0,\\sqrt{a/2})\\text{ 增},(\\sqrt{a/2},+\\infty)\\text{ 减}',
    acceptableAnswers: [
      'a\\le 0:(0,+\\infty)\\text{ 减};a>0:(0,\\sqrt{a/2})\\text{ 增},(\\sqrt{a/2},+\\infty)\\text{ 减}',
    ],
  },
];
